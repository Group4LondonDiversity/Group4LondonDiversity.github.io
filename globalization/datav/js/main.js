...
function openWorld() {
    ...
    var myBarChart2 = new Chart(worldchart, {
        ...
        data: {
            ...
            datasets: [{
                label: "Countries have the most migration connceted London",
...
map.on('load',function() {
    ...
    function popup(layer) {
        map.on('click', layer,function(e) {
            ...
            var description = "Country Name:" + e.features[0].properties.City + "<p>" + "Flight:" + e.features[0].properties.Migration;
